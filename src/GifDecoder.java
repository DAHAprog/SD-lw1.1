...
package com.aradam.catwar.tools;
...
public class GifDecoder
{
  ...
  public Animation<TextureAtlas.AtlasRegion> getAnimation (PlayMode playMode)
  {
    ...
    Array<TextureAtlas.AtlasRegion> texReg = new Array<TextureAtlas.AtlasRegion> ();
    ...
    for (h = 0; h < hzones; h++)
    {
      for (v = 0; v < vzones; v++)
      {
        ...
        if (frameID < nrFrames)
        {
          TextureAtlas.AtlasRegion tr = new TextureAtlas.AtlasRegion (texture, h * width, v * height, width, height);
          texReg.add (tr);
        }
      }
    }
    ...
    Animation<TextureAtlas.AtlasRegion> result = new Animation<TextureAtlas.AtlasRegion> (frameDuration, texReg, playMode);

    return result;
  }

  public static Animation<TextureAtlas.AtlasRegion> loadGIFAnimation (Animation.PlayMode playMode, InputStream is)
  {
